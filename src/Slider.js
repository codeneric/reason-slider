...
function Make(M) {
  var getTargetInnerHeight = function (target) {
    if (target !== undefined) {
      return Js_primitive.valFromOption(target).getBoundingClientRect().height;
    } else {
  ...
  var getTargetInnerWidth = function (target) {
    if (target !== undefined) {
      return Js_primitive.valFromOption(target).getBoundingClientRect().width;
    } else {
  ...
  var getCombokeys = function () {
    ...
    if (match !== undefined) {
      ...
      combokeys[0] = Js_primitive.some(ck);
      return ck;
    }
  };
  ...
  var callOnChange = function (param, items, onChange) {
    ...
    if (onChange !== undefined && match !== undefined) {
      var pointer = Js_primitive.valFromOption(match);
  ...
  var make$1 = function (items, renderSlide, onChange, render, $staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, _) {
    ...
    var renderNavigation = function (param) {
      ...
      var getFill = function (fn) {
        ...
        if (match !== undefined) {
          var match$1 = Curry._2(fn, Js_primitive.valFromOption(match), items);
          if (match$1) {
            return disabledFill;
          } else {
      ...
      return ReasonReact.element(undefined, undefined, Curry._5(Motion$ReasonSlider.New[/* TransitionMotion */1][/* make */0], undefined, (function () {
                        ...
                        return Js_null_undefined.fromOption(Js_primitive.some(Js_dict.fromList(/* :: */[
                                            /* tuple */[
                                              "progress",
                        ...
                        if (i.length !== 0) {
                          ...
                          return React.createElement("div", undefined, React.createElement("div", {
                                          ...
                                          disabled: match !== undefined ? isPointerLastEntry(Js_primitive.valFromOption(match), items) : true,
                                          onClick: (function () {
                                              return Curry._1(send, /* Next */2);
                                            })
                                          ...
                                          disabled: match$1 !== undefined ? isPointerFirstEntry(Js_primitive.valFromOption(match$1), items) : true,
                                          onClick: (function () {
                                              return Curry._1(send, /* Previous */3);
                                            })
    ...
    return /* record */[
            ...
            /* render */(function (self) {
                ...
                return React.createElement("div", undefined, ReasonReact.element(undefined, undefined, Curry._5(Motion$ReasonSlider.New[/* TransitionMotion */1][/* make */0], undefined, (function () {
                                      return Js_dict.fromList(/* :: */[
                                                  /* tuple */[
                                                    "progress",
                                                    0
                                          ...
                                          if (match$2 !== undefined) {
                                            try {
                                              tmp$1 = Curry._1(renderSlide, /* record */[
                                                    /* progress */progress,
                                                    /* item */Curry._2(M[/* getItem */0], Js_primitive.valFromOption(match$2), items),
                                                    /* close */closeFn
                                                  ]);
                                            }
                                            catch (exn){
                ...
                if (typeof action === "number") {
                    ...
                    case 2 : 
                        ...
                        if (match) {
                          ...
                          if (match$1 !== undefined) {
                            var pointer = Js_primitive.valFromOption(match$1);
                            ...
                            if (match$2) {
                              ...
                              return /* UpdateWithSideEffects */Block.__(2, [
                                        /* record */[
                                          ...
                                          /* showNavigation */state[/* showNavigation */1],
                                          /* pointer */Js_primitive.some(nextPointer(pointer, items))
                                        ],
                                        (function (self) {
                    ...
                    case 3 : 
                        ...
                        if (match$3) {
                          ...
                          if (match$4 !== undefined) {
                            var pointer$1 = Js_primitive.valFromOption(match$4);
                            ...
                            if (match$5) {
                              ...
                              return /* UpdateWithSideEffects */Block.__(2, [
                                        /* record */[
                                          /* isOpen */state[/* isOpen */0],
                                          /* showNavigation */state[/* showNavigation */1],
                                          /* pointer */Js_primitive.some(previousPointer(pointer$1, items))
                                        ],
                                        (function (self) {
                                            return callOnChange(self, items, onChange);
                                          })
                  ...
                  return /* UpdateWithSideEffects */Block.__(2, [
                            /* record */[
                              /* isOpen */true,
                              /* showNavigation */state[/* showNavigation */1],
                              /* pointer */Js_primitive.some(action[0])
                            ],
                            (function (self) {
                                bindShortcuts(self);
                                if (disableScroll) {
