...
function Make(M) {
  var getTargetInnerHeight = function (target) {
    if (target) {
      return target[0].getBoundingClientRect().height;
    } else {
  ...
  var getTargetInnerWidth = function (target) {
    if (target) {
      return target[0].getBoundingClientRect().width;
    } else {
  ...
  var calculateFullscreenImageDimensions = function (param, target) {
    ...
    var widthConstraint = Pervasives.min(originalX, getTargetInnerWidth(target));
    var heightConstraint = Pervasives.min(originalY, getTargetInnerHeight(target));
    var scale = Pervasives.min(widthConstraint / originalX, heightConstraint / originalY);
    return /* tuple */[
            originalX * scale | 0,
            originalY * scale | 0
          ];
  ...
  var maybeExecute = function (optionFn, args) {
    if (optionFn) {
      return Curry._1(optionFn[0], args);
    } else {
      return /* () */0;
    }
  };
  ...
  var isDesktop = function () {
    if (maybeBool(Bowser.mobile)) {
      ...
      return 1 - maybeBool(Bowser.tablet);
    }
  };
  ...
  var onResizeHandle = function (param, _) {
    var match = param[/* state */2][/* isOpen */0];
    if (match !== 0) {
      return Curry._1(param[/* send */4], /* Update */1);
    } else {
      return /* () */0;
    }
  };
  ...
  var combokeys = [/* None */0];
  var getCombokeys = function () {
  ...
  var bindShortcuts = function (param) {
    ...
    c.bind("left", (function () {
            return Curry._1(send, /* Previous */3);
          }));
    c.bind("right", (function () {
            return Curry._1(send, /* Next */2);
          }));
    return /* () */0;
  };
  var detachShortcuts = function () {
    var c = getCombokeys(/* () */0);
    c.detach();
    combokeys[0] = /* None */0;
    return /* () */0;
  };
  var disableScrollFn = function () {
    ((  document.body.style.overflow = "hidden"   ));
    return /* () */0;
  };
  var enableScrollFn = function () {
    ((  document.body.style.overflow = "initial"   ));
    return /* () */0;
  };
  var callOnChange = function (param, items, onChange) {
    var match = param[/* state */2][/* pointer */2];
    if (onChange) {
      if (match) {
        var pointer = match[0];
        return Curry._1(onChange[0], /* record */[
                    /* pointer */pointer,
                    /* items */items,
  ...
  var make$1 = function (items, renderSlide, onChange, render, $staropt$star, $staropt$star$1, $staropt$star$2, _) {
    var hideNavigationTimeout = $staropt$star ? $staropt$star[0] : 2000;
    var disableScroll = $staropt$star$1 ? $staropt$star$1[0] : /* true */1;
    var zIndex = $staropt$star$2 ? $staropt$star$2[0] : 1000;
    var renderNavigation = function (param) {
      ...
      var getFill = function (fn) {
        ...
        if (match) {
          var match$1 = Curry._2(fn, match[0], items);
          if (match$1 !== 0) {
            return disabledFill;
          } else {
      ...
      var arrow = function (fn, rotate) {
        return React.createElement("svg", {
                    ...
                    width: "64",
                    fill: getFill(fn),
                    transform: "rotate(" + (Pervasives.string_of_int(rotate) + ")"),
                    version: "1",
                    viewBox: "0 0 129 129",
      ...
      return ReasonReact.element(/* None */0, /* None */0, Curry._5(Motion$ReasonSlider.New[/* TransitionMotion */1][/* make */0], /* None */0, /* Some */[(function () {
                          ...
                          return Js_null_undefined.from_opt(/* Some */[Js_dict.fromList(/* :: */[
                                            /* tuple */[
                                              "progress",
                          ...
                          key: "arrows",
                          data: Js_null_undefined.from_opt(/* None */0)
                        }] : /* array */[], (function (i) {
                        if (i.length !== 0) {
                          ...
                          return React.createElement("div", undefined, React.createElement("div", {
                                          style: {
                                            ...
                                            top: "0",
                                            width: "10%",
                                            zIndex: Pervasives.string_of_int(zIndex + 1 | 0),
                                            alignItems: "center",
                                            justifyContent: "center"
                                          },
                                          disabled: match ? Js_boolean.to_js_boolean(isPointerLastEntry(match[0], items)) : true,
                                          onClick: (function () {
                                              return Curry._1(send, /* Next */2);
                                            })
                                          ...
                                          disabled: match$1 ? Js_boolean.to_js_boolean(isPointerFirstEntry(match$1[0], items)) : true,
                                          onClick: (function () {
                                              return Curry._1(send, /* Previous */3);
                                            })
    ...
    newrecord[/* render */9] = (function (self) {
        ...
        return React.createElement("div", undefined, ReasonReact.element(/* None */0, /* None */0, Curry._5(Motion$ReasonSlider.New[/* TransitionMotion */1][/* make */0], /* None */0, /* Some */[(function () {
                                return Js_dict.fromList(/* :: */[
                                            /* tuple */[
                                              "progress",
                                              0
                              ...
                              if (i.length !== 0) {
                                  ...
                                  if (match$2) {
                                    try {
                                      tmp$1 = Curry._1(renderSlide, /* record */[
                                            /* progress */progress,
                                            /* item */Curry._2(M[/* getItem */0], match$2[0], items),
                                            /* close */closeFn
                                          ]);
                                    }
                                    catch (exn){
                                ...
                                return ReasonReact.element(/* None */0, /* None */0, make(/* array */[React.createElement("div", {
                                                      style: {
                                                        ...
                                                        top: "0",
                                                        width: "100%",
                                                        zIndex: Pervasives.string_of_int(zIndex),
                                                        opacity: Pervasives.string_of_float(progress),
                                                        pointerEvents: match !== 0 ? "none" : "auto"
                                                      },
                                                      onClick: (function () {
                                                          return Curry._1(send, /* Close */0);
                                                        })
    ...
    newrecord[/* reducer */12] = (function (action, state) {
        if (typeof action === "number") {
          switch (action) {
            ...
            case 2 : 
                var match = 1 - state[/* isOpen */0];
                if (match !== 0) {
                  return /* NoUpdate */0;
                } else {
                  var match$1 = state[/* pointer */2];
                  if (match$1) {
                    var pointer = match$1[0];
                ...
                break;
            case 3 : 
                var match$3 = 1 - state[/* isOpen */0];
                if (match$3 !== 0) {
                  return /* NoUpdate */0;
                } else {
                  var match$4 = state[/* pointer */2];
                  if (match$4) {
                    var pointer$1 = match$4[0];
                    ...
                    if (match$5 !== 0) {
                      ...
                      return /* UpdateWithSideEffects */Block.__(3, [
                                /* record */[
                                  /* isOpen */state[/* isOpen */0],
                                  /* showNavigation */state[/* showNavigation */1],
                                  /* pointer : Some */[previousPointer(pointer$1, items)]
                                ],
                                (function (self) {
                                    return callOnChange(self, items, onChange);
                                  })
