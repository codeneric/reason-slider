...
module New = {
  ...
  external springWithConfig : (int, springConfig) => opaqueconfig = "spring";
  type style = Js.Dict.t(opaqueconfig);
  type plainStyle = Js.Dict.t(float);
  module Motion = {
    [@bs.module "react-motion"]
    external comp : ReasonReact.reactClass = "Motion";
    let make =
        (
      ...
      ReasonReact.wrapJsForReason(
        ...
        ~props={
          "style": style,
          "defaultStyle": defaultStyle |> Js.Nullable.fromOption,
        },
        children,
      );
  };
  module TransitionMotion = {
    type transitionStyle('data) = {
      .
      "key": string,
      "style": style,
    ...
    [@bs.module "react-motion"]
    external comp : ReasonReact.reactClass = "TransitionMotion";
    let make =
        (
          ...
          children:
            array(transitionPlainStyle('data)) => ReasonReact.reactElement,
        ) =>
      ReasonReact.wrapJsForReason(
        ~reactClass=comp,
        ~props={
          "styles": styles,
          "defaultStyles": defaultStyles |> Js.Nullable.fromOption,
          "willEnter": willEnter |> Js.Nullable.fromOption,
          "willLeave": willLeave |> Js.Nullable.fromOption,
        },
        children,
      );
  };
